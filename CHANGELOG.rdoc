...
* Rather than copy-pasting Capistrano's deploy.rb, we just add some behavior in after hooks. (Excellent idea Michael Hale, http://gihub.com/mikehale.) So your Capfile will have to change to something like:
